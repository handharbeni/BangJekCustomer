...
public class KurirDanKargo extends BangJeckSetting {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kurir_kargo);
    ...
    void goToHelp(){
        ...
        i.putExtra("url",base_url+"help_kurir_dan_kargo.html");
        startActivity(i);
    }
}